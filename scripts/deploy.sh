...
ENV_VARS="GOOGLE_CLOUD_PROJECT=${GOOGLE_CLOUD_PROJECT},GEMINI_MODEL=${GEMINI_MODEL:-gemini-3.8-flash},GMI_MODEL=${GMI_MODEL:-meta-llama/Llama-3.3-70B-Instruct},DIGIKEY_SANDBOX=${DIGIKEY_SANDBOX:-false}"
...
# Register all application secrets without removing unrelated secret bindings.
